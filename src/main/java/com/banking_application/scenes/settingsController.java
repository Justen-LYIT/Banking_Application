...
public class settingsController implements Initializable {
    ...
    public void switchToAccountSettingsScreen() throws IOException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("editAccountDetailsScene.fxml"));
        parent = loader.load();
        scene = new Scene(parent);
        editAccountDetailsController editAccountDetailsController = loader.getController();
        editAccountDetailsController.initData(this.loggedInCustomer);
        stage = (Stage) homePageImage.getScene().getWindow();
        stage.setScene(scene);
        stage.show();
    }
